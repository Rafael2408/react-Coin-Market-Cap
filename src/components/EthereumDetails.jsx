...
import ethIcon from 'cryptocurrency-icons/svg/color/eth.svg'; // Asegúrate de tener este ícono o cambia esta línea al ícono que quieras usar
...
function EthereumDetails() {
  ...
  const ethData = data.data.find(coin => coin.name === coinName);
