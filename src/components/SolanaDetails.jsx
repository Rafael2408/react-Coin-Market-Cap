...
function SolanaDetails() {
  ...
  const solData = data.data.find(coin => coin.name === coinName);
  ...
  return (
    <div className='p-2'>
      <div className='title'>
        <h2 className='text-center' style={{ color: 'black' }}>Detalles de Solana <img src={solIcon} alt="SOL Icon" width={35} /></h2>
        <h6 style={{ color: 'black' }}>{new Date(solData.last_updated).toLocaleString()}</h6>
      </div>
