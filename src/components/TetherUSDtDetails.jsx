...
import usdtIcon from 'cryptocurrency-icons/svg/color/usdt.svg'; // Asegúrate de tener este ícono o cambia esta línea al ícono que quieras usar

function TetherUSDtDetails() {
  ...
  const coinName = "Tether USDt";
  const usdtData = data.data.find(coin => coin.name === coinName);
  const quote = usdtData.quote.USD;
...
export default TetherUSDtDetails;
